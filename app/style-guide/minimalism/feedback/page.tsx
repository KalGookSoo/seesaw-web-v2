...
import {
  ...
  MinimalismConfirm,
  MinimalismModal
} from 'app/style-guide/minimalism/_components/feedback';
import {
  PageIntro,
  PreviewPanel,
  StyleGuideSection
...
const primaryButtonClassName =
  'rounded-lg bg-[var(--minimalism-blue)] px-5 py-3 text-sm font-semibold text-[var(--minimalism-accent-contrast)] transition-colors hover:bg-[var(--minimalism-blue-muted)]';
...
const inputClassName =
  'h-11 w-full rounded-lg border border-[var(--minimalism-separator)] bg-[var(--minimalism-surface)] px-3 font-mono text-xs text-[var(--minimalism-label)] outline-none focus:border-[var(--minimalism-blue)]';
    ...
    <>
      ...
      <StyleGuideSection eyebrow="Alert" title="Alert variants">
        <div className="grid gap-6 lg:grid-cols-2">
          <MinimalismAlert title="정보" variant="info">
            새 댓글 알림을 받을 수 있도록 브라우저 알림 권한을 허용해주세요.
          </MinimalismAlert>
          <MinimalismAlert title="성공" variant="success">
            캘린더 구독 URL이 클립보드에 복사되었습니다.
          </MinimalismAlert>
          <MinimalismAlert title="주의" variant="warning">
            현재 카테고리는 검색엔진 노출 대상이 아닙니다.
          </MinimalismAlert>
          <MinimalismAlert title="오류" variant="danger">
            요청 값을 다시 확인해주세요. UUID v4 형식이 아닙니다.
          </MinimalismAlert>
          <MinimalismAlert variant="neutral">
      ...
      <StyleGuideSection eyebrow="Modal" title="Modal sizes and actions">
        ...
        >
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-lg border border-[var(--minimalism-separator)] bg-[var(--minimalism-surface-grouped)] p-5">
              <p className="text-sm font-semibold text-[var(--minimalism-label)]">
                제목
              </p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <PreviewPanel title="Danger confirm">
            <div className="space-y-4">
              ...
              <button
                className="rounded-lg bg-[var(--minimalism-red)] px-5 py-3 text-sm font-semibold text-[var(--minimalism-danger-contrast)] transition-colors hover:brightness-110"
                type="button"
