...
const descriptionClassName =
  'font-serif text-sm leading-6 text-[var(--editorial-ink-soft)] italic';
        ...
        >
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-none border border-[var(--editorial-line-soft)] bg-[var(--editorial-surface-muted)] p-6">
              <p className="font-sans text-xs font-bold tracking-wider text-[var(--editorial-ink)] uppercase">
                제목
              </p>
              <p className="mt-2 font-serif text-sm text-[var(--editorial-ink-soft)] italic">
                7월 정기 독서 모임
              </p>
            </div>
            <div className="rounded-none border border-[var(--editorial-line-soft)] bg-[var(--editorial-surface-muted)] p-6">
