  ...
  return (
    <>
      <PageIntro title="Forms">
        Bootstrap 5 form 문서를 Tailwind 표면으로 옮긴 기준입니다. form control, select, checks, range, input group, floating label, layout,
        validation 상태를 이 페이지에서 함께 확인합니다.
      </PageIntro>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <PreviewPanel title="Overview">
            <div className="space-y-4">
              ...
              <p className={subtleTextClassName}>기본 입력 표면은 흰색, separator, blue focus ring으로 통일합니다.</p>
            </div>
          </PreviewPanel>
          ...
          <PreviewPanel title="Select">
            <div className="space-y-4">
              ...
              <label className="block space-y-2">
                ...
                <select className={`${inputClassName} bg-default-fill text-default-tertiary-label`} disabled>
          ...
          <PreviewPanel title="Checks & radios">
            <div className="space-y-4">
              <label className="text-default-label flex items-center gap-3 text-sm">
                <input type="checkbox" className="accent-default-blue size-4" defaultChecked />
                검색엔진에 노출
              </label>
              <label className="text-default-label flex items-center gap-3 text-sm">
                <input type="checkbox" className="accent-default-green size-4" />
                프로필 이미지 노출
              </label>
              <div className="flex flex-wrap gap-4">
                <label className="text-default-label flex items-center gap-2 text-sm">
                  <input name="visibility" type="radio" className="accent-default-blue size-4" defaultChecked />
                  공개
                </label>
                <label className="text-default-label flex items-center gap-2 text-sm">
                  <input name="visibility" type="radio" className="accent-default-blue size-4" />
                  비공개
                </label>
              </div>
            </div>
          ...
          <PreviewPanel title="Range">
            <div className="space-y-4">
              <label className="block space-y-3">
                ...
                <input type="range" min="0" max="10" defaultValue="6" className="accent-default-blue w-full" />
              </label>
          ...
          <PreviewPanel title="Input group">
            <div className="space-y-4">
              ...
              <div className="border-default-separator bg-default-surface flex overflow-hidden rounded-md border">
                <input className="text-default-label h-11 min-w-0 flex-1 px-3 text-sm outline-none" defaultValue="calendar.ics" />
                <button className="border-default-separator bg-default-blue border-l px-4 text-sm font-semibold text-white">복사</button>
              </div>
            </div>
          </PreviewPanel>
          ...
          <PreviewPanel title="Floating labels">
            <div className="space-y-4">
              <label className="relative block">
                ...
                <span className="text-default-secondary-label absolute top-2 left-3 text-xs font-medium">사이트 이름</span>
              </label>
              <label className="relative block">
                <input
                ...
                />
                <span className="text-default-red absolute top-2 left-3 text-xs font-medium">도메인 이름</span>
              </label>
            </div>
          </PreviewPanel>
          ...
          <PreviewPanel title="Validation">
            <div className="space-y-4">
              <label className="block space-y-2">
                ...
                />
                <span className="text-default-green text-xs font-medium">사용 가능한 값입니다.</span>
              </label>
              <label className="block space-y-2">
                ...
                <input
                  ...
                  defaultValue="blank"
                />
                <span className="text-default-red text-xs font-medium">UUID v4 형식이 아닙니다.</span>
              </label>
            </div>
          </PreviewPanel>
        </div>
