  ...
  return (
    <>
      <PageIntro title="Overview">
        스타일 가이드는 페이지 단위로 나누어 관리합니다. 각 페이지는 컴포넌트의 속성, 상태, 조합 사례를 분리해서 보여주며, `layout.html`의
        header, main, footer 골격을 Next.js 컴포넌트로 옮기기 전 기준선으로 사용합니다.
      </PageIntro>
      ...
      <StyleGuideSection eyebrow="Shell" title="Application layout preview">
        <PreviewPanel title="Header · Main · Footer">
          <div className="border-default-separator overflow-hidden rounded-lg border">
            ...
            <main className="bg-default-surface-grouped text-default-secondary-label px-4 py-10 text-sm">페이지 콘텐츠 영역</main>
