...
const primaryButtonClassName =
  'border-4 border-[var(--neo-brutalism-separator)] bg-[var(--neo-brutalism-blue)] px-5 py-3 text-sm font-black text-[var(--neo-brutalism-accent-contrast)] shadow-[3px_3px_0_var(--neo-brutalism-separator)] transition-transform hover:-translate-y-0.5';
...
const inputClassName =
  'h-11 w-full border-4 border-[var(--neo-brutalism-separator)] bg-[var(--neo-brutalism-surface)] px-3 font-mono text-xs font-bold text-[var(--neo-brutalism-label)] shadow-[3px_3px_0_var(--neo-brutalism-separator)] outline-none';
      ...
      <StyleGuideSection eyebrow="Modal" title="Modal sizes and actions">
        ...
        >
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="border-4 border-[var(--neo-brutalism-separator)] bg-[var(--neo-brutalism-surface-grouped)] p-5 shadow-[3px_3px_0_var(--neo-brutalism-separator)]">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <PreviewPanel title="Danger confirm">
            <div className="space-y-4">
              ...
              <button
                className="border-4 border-[var(--neo-brutalism-separator)] bg-[var(--neo-brutalism-red)] px-5 py-3 text-sm font-black text-[var(--neo-brutalism-danger-contrast)] shadow-[3px_3px_0_var(--neo-brutalism-separator)] transition-transform hover:-translate-y-0.5"
                type="button"
